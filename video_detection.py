...
class Detection():
    ...
    # detection with yolov3 model
    # which is more accurate
    def generic_detection(self):
        # Load Yolo
        net = cv2.dnn.readNet("complex_cfg/yolov3.weights",
                              "complex_cfg/yolov3.cfg")
        classes = []
        with open("cfg/coco.names", "r") as f:
            classes = [line.strip() for line in f.readlines()]
        layer_names = net.getLayerNames()
...
if __name__ == "__main__":
    test_object = Detection("test2.mp4")
    test_object.camera()
    test_object.tiny_detection()
    test_object.generic_detection()
"""
